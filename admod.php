        ...
        <div class="menu">
            <table class="menu-container" border="0">
                <tr>
                    ...
                    <img src="admin.png" width="100%" style="border-radius:50%">
</td>
...
<div class="wrapper">
 <ul>   
  <li><a href="dash.php"><i class="fa-solid fa-chart-line"></i>dashboard</a></li>
   ...
   <li><a href="tablepat.php"><i class="fa-solid fa-bed"></i>patient</a></li>
   <li><a href="schedule.php"> <i class="fa-solid fa-calendar-plus"></i>schedule</a></li>
